...
if (_sun) then
{
    _brightnessLow = 0;
    _brightnessHigh = 10;
    _attenuation = [0.001, 3000, 10, 125000];
} else {
    _brightnessLow = 0;
    _brightnessHigh = 60;
    _attenuation = [0.001, 3000, 10, 500000];
};
...
switch (_type) do
{
    ...
    {
        [false, "blue", [0.6, 2, -0.95]] call _attach;
        [true, "blue", [-0.6, 2, -0.95]] call _attach;
	...
	case "C_Van_01_box_F":
	{
        [false, "blue", [-0.85, -0.1, 1.4]] call _attach;
        [true, "blue", [0.85, -0.1, 1.4]] call _attach;
        [true, "red", [-0.93, -3.5, 1.4]] call _attach;
        [false, "red", [0.93, -3.5, 1.4]] call _attach;
