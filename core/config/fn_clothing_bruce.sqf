...
//Shop Title Name
ctrlSetText[3103,"Harry's Outfitters"];
...
switch (_filter) do
{
	...
	case 0:
	{
		...
		["U_OG_Guerilla2_1",nil,5000],
		["U_OG_Guerilla2_3",nil,5000],
		["BluePlaid_uni","Plaid (Blue)",125],
		["OrangePlaid_uni","Plaid (Orange)",350],
		["PinkPlaid_uni","Plaid (Pink)",350],
		["RedPlaid_uni","Plaid (Red)",350],
		["YellowPlaid_uni","Plaid (Yellow)",350],
	...
	case 3:
	{
		...
		["V_TacVest_camo",nil,1000],
		["V_TacVest_brn",nil,1000],
