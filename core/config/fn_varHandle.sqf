...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "handcuffs": {"life_inv_handcuffs"};//Handcuffs
            case "handcuffkeys": {"life_inv_handcuffkeys"};//Handcuff Keys
		};
	};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_handcuffs": {"handcuffs"};//Handcuffs
            case "life_inv_handcuffkeys": {"handcuffkeys"};//Handcuff Keys
		};
	};
};
