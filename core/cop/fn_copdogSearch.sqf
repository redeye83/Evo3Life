...
private["_civ","_invs","_license","_robber","_guns","_gun","_textbrah"];
...
if(count _invs > 0) then
{
	...
	[[0,format["K-9 unit just found illegal items on %1.",(_civ getVariable["realname",name _civ])]],"life_fnc_broadcast",(position player) nearEntities [["Man"], 25],false] spawn life_fnc_MP; 
