...
if (_number == 1) then {_slot1 = 100; _slotPic1 ctrlSetText "icons\stuff\slots\1.paa";};
if (_number == 2) then {_slot1 = 200; _slotPic1 ctrlSetText "icons\stuff\slots\2.paa";};
if (_number == 3) then {_slot1 = 300; _slotPic1 ctrlSetText "icons\stuff\slots\3.paa";};
if (_number == 4) then {_slot1 = 400; _slotPic1 ctrlSetText "icons\stuff\slots\4.paa";};
if (_number == 5) then {_slot1 = 500; _slotPic1 ctrlSetText "icons\stuff\slots\5.paa";};
if (_number == 6) then {_slot1 = 600; _slotPic1 ctrlSetText "icons\stuff\slots\6.paa";};
if (_number == 7) then {_slot1 = 700; _slotPic1 ctrlSetText "icons\stuff\slots\7.paa";};
...
if (_number == 1) then {_slot2 = 10; _slotPic2 ctrlSetText "icons\stuff\slots\1.paa";};
if (_number == 2) then {_slot2 = 20; _slotPic2 ctrlSetText "icons\stuff\slots\2.paa";};
if (_number == 3) then {_slot2 = 30; _slotPic2 ctrlSetText "icons\stuff\slots\3.paa";};
if (_number == 4) then {_slot2 = 40; _slotPic2 ctrlSetText "icons\stuff\slots\4.paa";};
if (_number == 5) then {_slot2 = 50; _slotPic2 ctrlSetText "icons\stuff\slots\5.paa";};
if (_number == 6) then {_slot2 = 60; _slotPic2 ctrlSetText "icons\stuff\slots\6.paa";};
if (_number == 7) then {_slot2 = 70; _slotPic2 ctrlSetText "icons\stuff\slots\7.paa";};
...
if (_number == 1) then {_slot3 = 1; _slotPic3 ctrlSetText "icons\stuff\slots\1.paa";};
if (_number == 2) then {_slot3 = 2; _slotPic3 ctrlSetText "icons\stuff\slots\2.paa";};
if (_number == 3) then {_slot3 = 3; _slotPic3 ctrlSetText "icons\stuff\slots\3.paa";};
if (_number == 4) then {_slot3 = 4; _slotPic3 ctrlSetText "icons\stuff\slots\4.paa";};
if (_number == 5) then {_slot3 = 5; _slotPic3 ctrlSetText "icons\stuff\slots\5.paa";};
if (_number == 6) then {_slot3 = 6; _slotPic3 ctrlSetText "icons\stuff\slots\6.paa";};
if (_number == 7) then {_slot3 = 7; _slotPic3 ctrlSetText "icons\stuff\slots\7.paa";};
