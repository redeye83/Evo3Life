...
*/
private["_bad","_unit","_markers","_randomspawn","_time"];
...
_markers = ["cell1","cell2","cell3","cell4","cell5","cell6"];
_randomspawn = _markers select floor random count _markers;
player setpos getmarkerpos _randomspawn;
...
if(player distance getMarkerPos _randomspawn > 40) then
{
	player setpos getmarkerpos _randomspawn;
};
