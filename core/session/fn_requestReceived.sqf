...
{
	case 1: {life_paycheck = life_paycheck + 500;}; //$25
	case 2: {life_paycheck = life_paycheck + 1000;}; //$50
	case 3: {life_paycheck = life_paycheck + 1500;}; //$75
	case 4: {life_paycheck = life_paycheck + 2000;}; //$100
	case 5: {life_paycheck = life_paycheck + 2500;}; //$250
};
...
switch(playerSide) do {
	...
	case civilian: {
		...
		{
			_housepos = call compile format ["%1", _x select 0]; 
			_house = (nearestobjects [_housepos,["house"],25]) select 0;
