/*
	...
	Needs to be revised.
*/
private["_dp","_target","_dpmark","_person"];
...
if(side _person != civilian) exitWith { hint "It seems your version of the Butter System is out of date, please update!" };
...
_dpmark = createMarkerLocal ["markername",[_dp]];
_dpmark setMarkerShapeLocal "ICON";
_dpmark setMarkerTypeLocal "FLAG";
